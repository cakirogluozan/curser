 ...
 */
     ...
     */
        ...
        /**
     * Store the initial Z position to preserve it for all duplicates
     */
        ...
        private void Start()
        {
            ...
            {
                var position = new Vector3(CalculateX(startingPos), startingPos.y, initialZ);
        ...
        private void Update()
        {
            ...
            foreach (var duplicate in duplicatesPool)
            {
                if (duplicate.transform.position.x < -spriteWidth * spriteRepositionIndex)
                {
                    ...
                    var position =
                        new Vector3(CalculateX(startingPos), startingPos.y, initialZ);
